    ...
    -->
        ...
        <header>
            ...
            <div class="header">
                ...
                -->
                <!-- Retrieve Email Login Inputted -->
                    <%String email=session.getAttribute("email").toString(); %>
                        <h2 style="text-align: right; color: yellow; padding-top: 30px; padding-bottom: 1px; font-size: 20px;"><%out.println(email);%><a href=""></a></h2>
                                    </nav>
                                </div>
                            </div>
                        </div>
