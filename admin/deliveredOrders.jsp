...
<div style="text-align: center;">
    <h1 style="text-align: center;"><u>Delivered Orders:</u></h1>
</div>
<br />
    ...
    <thead>
      ...
      <!-- Database Connection -->
        ...
        try 
        {
            ...
            ResultSet rs=st.executeQuery("select * from cart inner join products on cart.product_id=products.id and cart.orderDate is not NULL and cart.status='Delivered'");
            while(rs.next())
            {
        %>
